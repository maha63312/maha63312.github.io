...
result: |
  ...
  **Beskrivelse af ændringer**
  ...
  Diagrammet illustrerer, hvordan applikationslaget ikke har nogen afhængighedassets til Kafka, kun til sin port. Det skaber testbarhed og   udskiftelighed, og det er netop dét, Hexagonal Architecture tilstræber.
