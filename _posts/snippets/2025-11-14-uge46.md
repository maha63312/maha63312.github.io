...
result: |
  ...
  **Parsing af strict JSON:**  
  ...
  - mapping videre til domænemodellen  
  ...
  **Kodesnippet (Mapper):**  
  ...
  Mapperen sikrer:
  - stærkt typet domænemodel  
  - korrekt håndtering af confidence og metadata  
...
learning: |
  ...
  - mapping fra eksterne AI-modeller til interne domænestrukturer
