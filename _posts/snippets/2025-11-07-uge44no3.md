...
result: |
  ...
  **Billede**  
  ![JsonSchema](/assets/images/json_response_schema.png)
...
learning: |
  Arbejdet med evaluering af LLM-modeller og reduktion af hallucinationer har givet mig en dybere forståelse af, hvordan 
  AI-modeller opfører sig i praksis – og især hvordan man designer backend-arkitektur, der kan håndtere de usikkerheder, som   AI introducerer.

  Jeg har især lært:

  - hvordan forskellige LLM’er håndterer strukturerede outputs, og hvorfor JSON-schema er afgørende for robuste
    AI-integrationer  
...
next_plan: "Uge 45:  Implementere LLM ved at refaktorere HLD og LLD."
resources:
  - { title: "Gemini AI docs – Structured Output", url: "https://ai.google.dev/gemini-api/docs/structured-output?example=recipe" }
  - { title: "Hvad er hallucinering – Medium", url: "https://medium.com/@nirdiamant21/llm-hallucinations-explained-8c76cdd82532" }
  - { title: "Claude – Reducer hallucinationer", url: "https://docs.claude.com/en/docs/test-and-evaluate/strengthen-guardrails/reduce-hallucinations" }
  - { title: "Prompt Engineering – Google Cloud", url: "https://cloud.google.com/discover/what-is-prompt-engineering?hl=nb" }
  - { title: "Claude – Øg konsistens", url: "https://docs.claude.com/en/docs/test-and-evaluate/strengthen-guardrails/increase-consistency?utm_source=chatgpt.com" }
  - { title: "Claude – Structured Outputs", url: "https://docs.claude.com/en/docs/build-with-claude/structured-outputs" }
  - { title: "GPT – Structured Outputs", url: "https://platform.openai.com/docs/guides/structured-outputs#supported-schemas" }
