...
result: |
  ...
  **Nye læringsmål for de næste 14 dage:**  
  - Implementere LLM ved at refaktorere HLD og LLD.  
  - Skrive UnitTests, der kan bidrage til at kvalitetssikre driften af microservicen.  
  - Implementere og dokumentere håndteringen af credentials, så microservicen kan tilgå Google Vision Cloud og Gemini API’erne korrekt – både lokalt og i det fælles miljø.  
